...
public class UserServiceImpl implements UserService {
    ...
    public Optional<UserResponse> getLoggedUserResponse() {
        UserResponse userResponse = userMapper.userEntityToResponse(getAuthorizedUser());
    ...
    public Optional<UserRepresentation> getUserRepresentationByEmail(String email) {
        return userRepository.findUserEntityByEmail(email)
                .map(userEntity -> UserRepresentation.builder()
                        .id(userEntity.getId())
                        .email(userEntity.getEmail())
                        .username(userEntity.getUsername())
                        .password(userEntity.getPassword())
                        .role(userEntity.getEmail())
                        .build());
    }
    ...
    public Optional<UserResponse> createUser(UserRequest userRequest) {
        ...
        return Optional.of(userMapper.userEntityToResponse(userRepository.save(user)));
    }
