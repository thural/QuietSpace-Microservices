...
import com.jellybrains.quietspace.notification_service.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCustomDataNotFoundExceptions(CustomNotFoundException e) {
